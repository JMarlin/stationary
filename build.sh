...
nasm -o hq2x16.o -felf64 peops/hq2x16.asm -I ./peops/ -Wno-warning
nasm -o hq2x32.o -felf64 peops/hq2x32.asm -I ./peops/ -Wno-warning
nasm -o hq3x16.o -felf64 peops/hq3x16.asm -I ./peops/ -Wno-warning
nasm -o hq3x32.o -felf64 peops/hq3x32.asm -I ./peops/ -Wno-warning
nasm -o i386.o -felf64 peops/i386.asm -I ./peops/ -Wno-warning
